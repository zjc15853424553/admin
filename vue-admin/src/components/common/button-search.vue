<template>
	<div>
		<div class="d-flex align-items-center pb-3">
			<slot name="left"></slot>
			<div class="d-flex align-items-center ml-auto" v-show="!superSearch" v-if="">
				<slot name="right">
					<el-input class="mr-2" v-model="keyword" :placeholder="placeholder" size="mini" style="width: 150px;"></el-input>
		...
		<el-card class="box-card my-3 bg-light" v-show="superSearch">
